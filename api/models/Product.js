    ...
    try {
      ...
      const query = `
        INSERT INTO productos (
          ...
          precio, descuento, stock, estado, imagen_frente_url, imagen_espalda_url, usuario_id, proveedor, genero
    ...
    try {
      ...
      const query = `
        ...
        SET nombre = $2, descripcion = $3, categoria = $4, talle = $5, 
            color = $6, marca = $7, precio = $8, descuento = $9, stock = $10, estado = $11, 
            imagen_frente_url = $12, imagen_espalda_url = $13, proveedor = $14, genero = $15, fecha_actualizacion = CURRENT_TIMESTAMP
        WHERE id = $1
        RETURNING *
      `;
      ...
      const values = [
        ...
        precio, descuento, stock, estado, imagen_frente_url, imagen_espalda_url, proveedor, genero
      ];
