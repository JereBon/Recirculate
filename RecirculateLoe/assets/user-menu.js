...
class UserMenuManager {
    ...
    // ** Lógica para actualizar los enlaces del sidebar **
    updateSidebarAuthLinks() {
        const loginLink = document.getElementById('sidebarLoginLink');
        const registerLink = document.getElementById('sidebarRegisterLink');
        
        if (!loginLink || !registerLink) return;

        if (this.isLoggedIn) {
            // Si está logueado: Cambiar "INICIAR SESIÓN" a "CERRAR SESIÓN"
            loginLink.href = 'javascript:void(0);'; 
            loginLink.textContent = 'CERRAR SESIÓN';
            // Asignar el método logout directamente
            ...
            // Si no está logueado: Restaurar a "INICIAR SESIÓN" y "REGISTRARSE"
            // Las rutas en el HTML son las correctas: '../../auth/login.html' para home.html, etc.
            
            // ** LÓGICA DE RUTA CORREGIDA para restablecer el HREF **
            const currentPath = window.location.pathname;
            let loginUrl = '../../auth/login.html'; // Default para /home/ y /carrito/
            ...
            loginLink.onclick = null; // Remover listener de logout
